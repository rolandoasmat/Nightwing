...
public class WatchLaterMoviesGridFragment extends Fragment
        implements MovieAdapterOnClickHandler {

    private MoviesGridAdapter mMoviesGridAdapter;
    private Context context;

    public WatchLaterMoviesGridFragment() { }
    ...
    private void fetchMovies() {
        LiveData<Movie[]> liveData = DatabaseManager.INSTANCE.getWatchLaterMovies();
