...
abstract public class BaseGridFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(context, ViewUtils.INSTANCE.calculateNumberOfColumns(context));
        if(adapter == null) {
        ...
        liveData.observe(this, new Observer<Movie[]>() {
            ...
            public void onChanged(@Nullable Movie[] movies) {
                ...
                if (movies == null || movies.length == 0) {
                    ...
                    layoutManager.setSpanCount(ViewUtils.INSTANCE.calculateNumberOfColumns(context));
                }
