...
import com.asmat.rolando.nightwing.tv_season_details.TvSeasonDetailsFragment
...
interface ApplicationComponent {
    ...
    fun inject(fragment: SavedTvShowsFragment)
    fun inject(fragment: TvSeasonDetailsFragment)
}